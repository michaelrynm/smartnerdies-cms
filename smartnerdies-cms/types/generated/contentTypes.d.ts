...
export interface ApiAdminModalAdminModal extends Struct.CollectionTypeSchema {
  collectionName: 'admin_modals';
  info: {
    displayName: 'AdminModal';
    pluralName: 'admin-modals';
    singularName: 'admin-modal';
  };
  options: {
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Card_1_Description: Schema.Attribute.String;
...
export interface ApiStatisticStatistic extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Average_Rating: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    Satisfaction_Rate: Schema.Attribute.String;
    Task_Completed: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiWorkWork extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Work_Image: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    Work_Tag_1: Schema.Attribute.String;
    Work_Tag_2: Schema.Attribute.String;
    Work_Tag_3: Schema.Attribute.String;
    Work_Tag_4: Schema.Attribute.String;
